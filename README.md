...
(20) Следующая рассматриваемая логическая операция - **XOR** - из лекции мы знаем, что однслоный перцептрон не должен быть способным находить веса для данной логической операции, проверим это и запустим **10 эпох**. Даже после **10 эпох** количество неправильных выходных данных было равно 4/4:
