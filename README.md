...
![image](https://user-images.githubusercontent.com/100014698/205124651-fa2d055f-1471-47e8-af9b-f6c51dccde71.png)

----------------------------------------------------------------------------------------------------------------------------------------

- Операция AND | И

![image](https://user-images.githubusercontent.com/100014698/205125080-6b4ee7df-b12e-4e31-899a-6dc1aec22416.png)

----------------------------------------------------------------------------------------------------------------------------------------

- Операция NAND | НЕ-И

![image](https://user-images.githubusercontent.com/100014698/205125541-1e56ab02-eff6-4d83-a745-d1bf7c80c069.png)

----------------------------------------------------------------------------------------------------------------------------------------

- Операция XOR | исключающее ИЛИ

> здесь идет учет ошибок каждой для каждого слоя перцептрона

![image](https://user-images.githubusercontent.com/100014698/205126753-a2a0f8ab-9f48-42c3-af87-ef263a2c5a89.png)

----------------------------------------------------------------------------------------------------------------------------------------

## Вывод по заданию 2:
Количество ошибок зависит от решаемой операции, для операции OR (самая простая) необходимо меньшее колчество эпох чем для AND (более сложная)
А для нелинейного XOR и вовсе нужен даже не один слой перцептрона и более 7-8 эпох обучения


## Выводы

В ходе лабораторной работы, я познакомился с одной из моделей нейроной сети, а именно - перцептроном. Узнал о проблеме линейности перцептрона, научился добавлять слои для решения нелинейных задач. Научился реализовывать простейшие логические задачи (AND, OR, HAND, XOR). Проанализировал зависимость количества эпох обучения от ошибок обучения.
